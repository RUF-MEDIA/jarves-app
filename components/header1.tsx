    ...
    <nav className="max-w-7xl flex basis-full items-center w-full mx-auto px-4 sm:px-6 lg:px-8" aria-label="Global">
      <div className="me-5 md:me-8">
        <a className="flex-none text-xl font-semibold dark:text-white" href="/#" aria-label="Brand">
          <Image src="/images/Logo-rec2rec.svg" alt="Logo" width={130} height={130} />
        </a>
      </div>
      ...
      <div className="w-full flex items-center justify-end ms-auto sm:justify-between sm:gap-x-3 sm:order-3">
        ...
        <div className="flex flex-row items-center justify-end gap-2">
          <button
            type="button"
            className="w-[2.375rem] h-[2.375rem] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700"
          >
            <svg
              className="flex-shrink-0 size-4"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="hs-dropdown relative inline-flex" data-hs-dropdown-placement="bottom-right">
            ...
            >
              <img
                className="inline-block w-[2.375rem] h-[2.375rem] rounded-full ring-2 ring-white dark:ring-neutral-900 object-cover"
                src="/images/Foto_Matthias.jpg"
                alt="Matthias Ruf"
              />
            </button>
