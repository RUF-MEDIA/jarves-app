    ...
    return (
      <div className="flex space-x-1">
        {Array.from({ length: 5 }, (_, i) => (
          <FaStar key={i} className="w-4 h-4" color={i < rating ? 'gold' : 'gray'} />
        ))}
      </div>
    );
  };
          ...
          <TableHeader>
            <TableRow className="bg-gray-200">
              ...
              {columns
                ...
                .map((col) => (
                  <TableHead key={col.key} onClick={() => handleSort(col.key)} className="px-4 py-2 cursor-pointer select-none">
